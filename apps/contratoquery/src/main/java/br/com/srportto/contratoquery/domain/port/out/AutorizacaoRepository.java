 ...
 * (D3, D4): filtro e ordenação trafegam como {@link Ordenacao}, value object de domínio, nunca
 * como caminho de propriedade JPA ou código numérico de banco — a tradução para os dois é
 * responsabilidade exclusiva do adaptador.
 */
