...
class TipoEventoAutorizacaoTest {
    ...
    void derivaTipoParaCadaStatus() {
        assertEquals(TipoEventoAutorizacao.RECEPCAO,
                TipoEventoAutorizacao.porStatus(StatusAutorizacao.RECEBIDA.getStatusAutorizacao()));
        assertEquals(TipoEventoAutorizacao.PENDENCIA_ACEITE,
                TipoEventoAutorizacao.porStatus(StatusAutorizacao.PENDENTE_ACEITE.getStatusAutorizacao()));
        assertEquals(TipoEventoAutorizacao.INICIO_ATIVACAO,
                TipoEventoAutorizacao.porStatus(StatusAutorizacao.EM_PROCESSO_ATIVACAO.getStatusAutorizacao()));
        ...
        assertEquals(TipoEventoAutorizacao.FINALIZACAO,
                TipoEventoAutorizacao.porStatus(StatusAutorizacao.FINALIZADA.getStatusAutorizacao()));
    }
