 ...
 * do banco preenchidos via {@link #comAutorizacaoCarregada}, sem mutar o comando original.
 */
public record DecidirAutorizacaoCommand(
    ...
    public static DecidirAutorizacaoCommand doRequest(String idAutorizacao, TipoProduto tipoProduto,
