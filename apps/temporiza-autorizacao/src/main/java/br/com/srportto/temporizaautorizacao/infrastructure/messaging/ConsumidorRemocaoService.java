...
/**
 * Remoção segura de consumidor, compartilhada entre
 * {@link br.com.srportto.temporizaautorizacao.infrastructure.config.ValkeyStreamConfig} e
 * {@link br.com.srportto.temporizaautorizacao.infrastructure.scheduler.ConsumidoresOrfaosLimpezaScheduler}.
 * "Segura": nunca remove com PEL não vazio — {@code XGROUP DELCONSUMER} descarta as pendências do
