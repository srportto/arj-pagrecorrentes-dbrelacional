...
(`ObjectOptimisticLockingFailureException`/conflito de lock otimista no contratocommand,
...
- Sem mudança de schema, endpoint público ou infraestrutura. Sem mudança no `contratocommand`.
