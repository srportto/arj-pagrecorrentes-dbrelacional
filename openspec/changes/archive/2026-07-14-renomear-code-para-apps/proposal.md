...
- `readme-raiz`: o requirement "README de raiz linka para documentação de cada app" passa a exigir links para `apps/arj-contratocommand/README.md` e `apps/arj-contratoquery/README.md`.
- `documentacao-contratoquery`: o requirement "Aplicação contratoquery deve possuir arquivos de documentação na raiz" passa a referenciar `apps/arj-contratoquery/` em vez de `code/arj-contratoquery/`.
...
- `higiene-comentarios-codigo`: a descrição e o requirement "Comentários de código existem apenas para explicar um porquê não óbvio" passam a referenciar `apps/arj-contratocommand` e `apps/arj-contratoquery` em vez de `code/...`.
