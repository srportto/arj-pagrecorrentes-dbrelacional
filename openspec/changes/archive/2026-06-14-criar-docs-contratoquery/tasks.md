...
- [x] 1.1 Criar `aplicacoes/contratoquery/CLAUDE.md` com seção "Comece por aqui" apontando para `AutorizacaoController.java`, `ListarAutorizacoesService.java`, `ConsultarAutorizacaoService.java` e `Autorizacao.java` da query
...
- [x] 1.7 Criar `aplicacoes/contratoquery/AGENTS.md` com conteúdo idêntico ao `CLAUDE.md` recém-criado

## 2. README.md

- [x] 2.1 Criar `aplicacoes/contratoquery/README.md` com seção "Sobre o Projeto" descrevendo a query como serviço de leitura (GET) do par de microserviços
