## 1. contratocommand — Enum TipoJornadaAutorizacao
...
## 2. contratocommand — Record CriarAutorizacaoRequest
...
## 4. contratocommand — Mappers (motivoStatus)
...
- [x] 5.7 Executar `mvn test` no módulo `contratocommand` e garantir que todos os testes passam

## 6. contratoquery — DTOs de resposta
...
- [x] 7.3 Executar `mvn test` no módulo `contratoquery` e garantir que todos os testes passam
