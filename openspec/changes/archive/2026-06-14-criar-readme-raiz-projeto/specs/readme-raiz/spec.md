...
O `README.md` SHALL conter links para `aplicacoes/contratocommand/README.md` e `aplicacoes/contratoquery/README.md`, bem como para os arquivos relevantes em `docs/`.
